...
import featureImage from '../assets/img/feature.jpg';  // Adjust path according to your folder structure
import CommonHeader from '../components/CommanHeader';

const Feature = ({ showHeader = true }) => {
  return (
    <>
      {showHeader && (
        <CommonHeader title="Feature" currentPage="Feature" />
      )}
          ...
          <div className="row">
            ...
            <div className="col-lg-5" style={{ minHeight: '500px' }}>
              <div className="position-relative h-100">
                <img className="position-absolute w-100 h-100" src={featureImage} alt="Feature" style={{ objectFit: 'cover' }} />
              </div>
            </div>
          </div>
        </div>
